...
<div id="mainwrap">
	...
	?>
		...
		<?php /* PHP Script for the task Scheduler Page */
		/* Includes */
				...
				<fieldset id="tableFieldset">
					...
					<form name="taskForm" action="lib/crud/scheduler.crud.php" method="POST" class="myform stylizedForm stylized" style="width:100%;">
						...
						onchange="switch(this.value){
							case '1': displayDownloadElements(); 
							break; 
							case '2': displayReportElements(); 
							break; 
							case '3': displaySnippetElements(); 
							break; 
						}">
						...
						<div name="snippetSlctDiv" id ="snippetSlctDiv">
							...
							<?php 	if(isset($errors['snippetSlct'])){echo "<span class=\"error\">".$errors['snippetSlct']."</span><br/>";} ?>
							</label>
						...
						<div class="spacer"></div>
						<?php  if(isset($errors['taskName'])){echo "<span class=\"error\">".$errors['taskName']."</span><br/>";} ?>
						</label>
