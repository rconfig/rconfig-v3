    ...
    $.fn.jPaginate = function (options) {
        ...
        return this.each(function () {
            ...
            function showPage(page) {
                obj.children().hide();
                //console.log(array_of_elements[page])
            ...
            function createPagination(curr) {
                ...
                start = "<ul class='" + options.pagination_class + " " + options.goto + "'>";
                
                if (previous) {
                    var previous = "<li><a class='goto_previous"+options.goto+"' href='#'>" + options.previous + "</a></li>";
                    var previous_inactive = "<li><a class='inactive'>" + options.previous + "</a></li>";
                } else {
                    var previous = '<li></li>';
                    var previous_inactive = '<li></li>';
                }
                
                if (next) {
                    var next = "<li><a class='goto_next"+options.goto+"' href='#'>" + options.next + "</a></li>";
                    var next_inactive = "<li><a class='inactive'>" + options.next + "</a></li>";
                    end = "</ul><br clear='all' />";
                } else {
                    var next = '<li></li>';
                    var next_inactive = '<li></li>';
                    end = "</ul>";
                }
                    ...
                    if (options.minimize === true) {
                        ...
                        if (i >= pagi_range.start && i <= pagi_range.end) {
                            if (i == curr) {
                                ...
                                items += '<li><a href="#" class="goto'+options.goto+'" title="' + i + '">' + i + '</a></li>';
                            }
                        } else if (curr <= half) {
            ...
            $(".goto"+options.goto).live("click", function (e) {
                e.preventDefault();
            ...
            $(".goto_next"+options.goto).live("click", function (e) {
                e.preventDefault();
            ...
            $(".goto_previous"+options.goto).live("click", function (e) {
                e.preventDefault();
                var act = "." + options.active;
                var newcurr = parseInt($(".pagination").find(".active").attr("title")) - 1;
                set_cookie("current", newcurr);
